...
# Tässä laitettuna polku frontin templates kansioon
...
SECRET_KEY = 'django-insecure-g7-50w!06^v7awvgv60dxle%c(e)h$5bv&s0%%1lcz7q1h2e+@'
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATES_DIR, os.path.join(BASE_DIR, 'drf_api/build'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
